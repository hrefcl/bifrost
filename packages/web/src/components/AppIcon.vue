...
/**
 * Set de iconos (derivado de lucide, trazo) portado 1:1 desde la maqueta.
 * El contenido SVG es un literal estático del módulo (no entra dato de usuario),
 * por eso `v-html` es seguro aquí.
 */
...
<template>
  <!-- v-html: `path` es un literal estático del módulo (sin dato de usuario) → seguro. -->
