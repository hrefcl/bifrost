...
export default {
  ...
  composer: {
    ...
    dropHere: 'Suelta los archivos para adjuntarlos',
    uploading: 'Subiendo…',
  ...
  profileGate: {
    ...
    subtitle: 'Un paso rápido para que tus correos salgan completos',
    why: 'Tu cuenta {email} todavía no tiene tu nombre completo. Completa tu nombre y teléfono para que tu firma salga bien en los correos que envíes.',
    nameLabel: 'Nombre completo',
    namePlaceholder: 'Ej: Francisco Arenas',
    phoneLabel: 'Teléfono',
    phonePlaceholder: 'Ej: +56 9 1234 5678',
    photoPick: 'Subir foto',
    photoRemove: 'Quitar',
    photoHint: 'Opcional · PNG/JPG hasta 2 MB',
    save: 'Guardar y continuar',
    saving: 'Guardando…',
    logout: 'Cerrar sesión',
    errName: 'Escribe tu nombre completo (no el usuario del correo).',
    errPhone: 'Ingresa un teléfono válido.',
    errPhoto: 'El archivo debe ser una imagen.',
    errPhotoSize: 'La imagen supera los 2 MB.',
