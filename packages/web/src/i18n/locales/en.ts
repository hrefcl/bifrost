...
export default {
  ...
  contacts: {
    ...
    errEmail: 'Add at least one email.',
    errEmailFormat: 'Invalid email: {email}',
    errSave: 'Could not save the contact.',
    import: 'Import',
    importing: 'Importing…',
    importCta: 'Import from a file (.vcf / .csv)',
    importResult: 'Imported {imported} of {total} · {skipped} already existed or skipped.',
    importError: 'Could not import the file. Use a .vcf or .csv.',
  },
  calendar: {
    title: 'Calendar',
    new: 'Create',
    ...
    google: {
      ...
      intro: 'Connect your Google Calendar to see your Bifrost events from Gmail.',
      connect: 'Connect Google Calendar',
      connecting: 'Connecting…',
      connectedAs: 'Connected as {email}',
      connected: 'Connected',
      disconnect: 'Disconnect',
      syncError: 'There was a problem syncing with Google.',
      retry: 'Retry',
      lastSynced: 'Last synced: {when}',
      okConnected: 'Google Calendar connected.',
      errConnect: 'Could not connect to Google. Please try again.',
    ...
    withMeet: 'Add a Bifrost Meet video call',
    attendeePlaceholder: 'Invite by email',
    addAttendee: 'Add',
    account: 'Account',
    start: 'Start',
    end: 'End',
  ...
  admin: {
    ...
    signatures: {
      ...
      tabStyle: 'Style',
      styleCompany: 'Company',
      styleTagline: 'Tagline / phrase',
      styleColor: 'Accent color',
      styleFont: 'Typography',
      stylePhoto: 'Photo size',
      styleAlign: 'Alignment',
      alignLeft: 'Left',
      alignCenter: 'Center',
      alignRight: 'Right',
      stylePhotoPad: 'Photo padding',
      styleLogoSize: 'Logo size',
      styleLogoAlign: 'Logo alignment',
      styleLogoPad: 'Logo padding',
      styleSep: 'Separator',
      ...
      styleLogoHint:
        'PNG/JPG up to 256KB. Horizontal is used in most; vertical in stacked/centered designs.',
      preview: 'Preview',
    ...
    gcal: {
      ...
      sourceError:
        'Invalid configuration (the secret could not be decrypted). Re-enter the credentials.',
    ...
    branding: {
      ...
      iconStyleHint: 'Applies platform-wide, for all your employees.',
      iconWeights: {
        thin: 'Thin',
        light: 'Light',
        regular: 'Regular',
  ...
  settings: {
    ...
    profile: {
      title: 'Profile',
      desc: 'Your name and photo. The photo is also used in your email signature.',
      name: 'Display name',
      namePh: 'Your name',
      photoHint: 'PNG/JPG/WEBP/GIF, up to 2 MB. Used as your avatar and in your signature.',
      save: 'Save profile',
      saved: 'Saved',
    },
    appearance: 'Appearance',
  ...
  profileGate: {
    ...
    subtitle: 'A quick step so your emails go out complete',
    why: "Your account {email} doesn't have your full name yet. Add your name and phone so your signature looks right on the emails you send.",
    nameLabel: 'Full name',
    namePlaceholder: 'e.g. Francisco Arenas',
    phoneLabel: 'Phone',
    phonePlaceholder: 'e.g. +56 9 1234 5678',
    photoPick: 'Upload photo',
    photoRemove: 'Remove',
    photoHint: 'Optional · PNG/JPG up to 2 MB',
    save: 'Save and continue',
    saving: 'Saving…',
    logout: 'Log out',
    errName: 'Enter your full name (not the email username).',
    errPhone: 'Enter a valid phone number.',
    errPhoto: 'The file must be an image.',
    errPhotoSize: 'The image is larger than 2 MB.',
